...
- Fix build cache relocatability when using Baseline by storing relative paths in `LintErrorResult` [#1074](https://github.com/JLLeitschuh/ktlint-gradle/pull/1074)
