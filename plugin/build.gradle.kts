...
dependencies {
    ...
    add("adapter49CompileOnly", "com.pinterest.ktlint:ktlint-rule-engine:1.5.0")
    ...
    add("adapter50CompileOnly", "com.pinterest.ktlint:ktlint-rule-engine:1.5.0")
    ...
    add("adapter100CompileOnly", "com.pinterest.ktlint:ktlint-rule-engine:1.5.0")
